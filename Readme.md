...
Mở và chạy toàn bộ file notebooks/A_EDA.ipynb trước. Code sẽ tự động làm sạch dữ liệu, vẽ biểu đồ và xuất ra file data/clean/student_depression_clean.csv.

Mở và chạy tiếp file notebooks/B_Inference.ipynb để thực hiện các suy luận thống kê và huấn luyện mô hình Machine Learning.
